...
const ViviendanuevaTablaComponent = () => {
  ...
  // console.log(contcodData[0].ploc_cod);

  useEffect(() => {
    const fetchData3 = async () => {
      if (contcodData.length > 0) {
        try {
          // const url = `${process.env.NEXT_PUBLIC_BASE_URL_BACKEND}/datoscontrato/compleja/${selectedContCod}/CT_PL?ploccod=${contcodData[0].ploc_cod}&ploccod=${contcodData[1].ploc_cod}&ploccod=${contcodData[3].ploc_cod}`;
          // const url = `${process.env.NEXT_PUBLIC_BASE_URL_BACKEND}/datoscontrato/compleja/${selectedContCod}/${contcodData.titr_cod}?ploccod=${contcodData.ploc_cod}&ploccod=${contcodData.ploc_cod}`;
          const baseUrl = process.env.NEXT_PUBLIC_BASE_URL_BACKEND;
          // const selectedContCod = "CT_PL"; // Cambiar si es necesario
...
export default ViviendanuevaTablaComponent;
